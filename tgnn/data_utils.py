...
class DataUtils:
    ...
    @staticmethod
    def save_dataset_list(dataset_list:list,mode:str,num_nodes:int,chunk_size:int,dir_type:Literal['train','val','test']):
        ...
        for idx,chunk in tqdm(enumerate(chunk_list),desc=f"Saving {mode}_{num_nodes}_chunk_{chunk_size}..."):
